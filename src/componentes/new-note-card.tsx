...
export function NewNoteCard( {onNoteCreated}: NewNoteCardProps ) {
   ...
   function handleStopRecording() {
    ...
    setIsRecording(false) // Estou dizendo que ele não está gravando(false).
    
    if(speechRecognition !== null) {
      speechRecognition.stop() // Estou parando a gravação.
    }
   }
            ...
            {shouldShowOnbording ? (
              ...
              {isRecording ? (
                  <button 
                    ...
                    <div className='size-3 rouded-full bg-red-500 animate-pulse' />
